            ...
            <div className='article article_outer-wrap'>
                <article className='article__inner-wrap'>
                    ...
                    <p className='article__text article__text_about'>
                        ...
                        сын и дочь. Около 20 лет работал в аэропортовой сфере, увлекаюсь путешествиями. С начала 2022г. начал кодить.
                        ...
                        Хочу полностью перейти на веб-разработку и программирование.
                    </p>
                    </span>
